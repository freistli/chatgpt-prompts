...
export type ChatGPTPromptParams = ConstructorParameters<typeof AzureChatGPTAPI>[0];

export type ChatGPTPromptsClient = (instance: AzureChatGPTAPI) => ChatGPTPromptsCollection;
...
export interface ChatGPTPromptsCollection {
   ...
   */
  linuxTerminal: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  englishTranslatorAndImprover: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  positionInterviewer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  javaScriptConsole: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  excelSheet: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  englishPronunciationHelper: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  spokenEnglishTeacherAndImprover: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  travelGuide: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  plagiarismChecker: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  characterFromMovieBookAnything: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  advertiser: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  storyteller: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  footballCommentator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  standUpComedian: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  motivationalCoach: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  composer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  debater: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  debateCoach: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  screenwriter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  novelist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  movieCritic: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  relationshipCoach: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  poet: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  rapper: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  motivationalSpeaker: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  philosophyTeacher: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  philosopher: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  mathTeacher: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  aiWritingTutor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  uxUiDeveloper: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  cyberSecuritySpecialist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  recruiter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  lifeCoach: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  etymologist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  commentariat: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  magician: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  careerCounselor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  petBehaviorist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  personalTrainer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  mentalHealthAdviser: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  realEstateAgent: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  logistician: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  dentist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  webDesignConsultant: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  aiAssistedDoctor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  doctor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  accountant: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  chef: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  automobileMechanic: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  artistAdvisor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  financialAnalyst: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  investmentManager: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  teaTaster: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  interiorDecorator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  florist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  selfHelpBook: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  gnomist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  aphorismBook: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  textBasedAdventureGame: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  aiTryingToEscapeTheBox: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  fancyTitleGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  statistician: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  promptGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  instructorInASchool: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  sqlTerminal: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  dietitian: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  psychologist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  smartDomainNameGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  techReviewer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  developerRelationsConsultant: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  academician: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  itArchitect: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  lunatic: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  gaslighter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  fallacyFinder: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  journalReviewer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  diyExpert: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  socialMediaInfluencer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  socrat: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  socraticMethod: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  educationalContentCreator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  yogi: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  essayWriter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  socialMediaManager: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  elocutionist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  scientificDataVisualizer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  carNavigationSystem: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  hypnotherapist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  historian: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  astrologer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  filmCritic: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  classicalMusicComposer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  journalist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  digitalArtGalleryGuide: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  publicSpeakingCoach: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  makeupArtist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  babysitter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  techWriter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  asciiArtist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  pythonInterpreter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  synonymFinder: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  personalShopper: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  foodCritic: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  virtualDoctor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  personalChef: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  legalAdvisor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  personalStylist: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  machineLearningEngineer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  biblicalTranslator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  svgDesigner: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  itExpert: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  chessPlayer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  midjourneyPromptGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  fullstackSoftwareDeveloper: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  mathematician: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  regexGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  timeTravelGuide: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  dreamInterpreter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  talentCoach: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  rProgrammingInterpreter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  stackOverflowPost: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  emojiTranslator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  phpInterpreter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  emergencyResponseProfessional: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  fillInTheBlankWorksheetsGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  softwareQualityAssuranceTester: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  ticTacToeGame: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  passwordGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  newLanguageCreator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  webBrowser: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  seniorFrontendDeveloper: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  solrSearchEngine: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  startupIdeaGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  spongebobsMagicConchShell: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  languageDetector: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  salesperson: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  commitMessageGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  chiefExecutiveOfficer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  diagramGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  lifeCoach2: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  speechLanguagePathologistSlp: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  startupTechLawyer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  titleGeneratorForWrittenPieces: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  productManager: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  drunkPerson: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  mathematicalHistoryTeacher: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  songRecommender: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  coverLetter: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  technologyTransferer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  unconstrainedAiModelDan: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  gomokuPlayer: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  proofreader: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  buddha: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  muslimImam: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  chemicalReactor: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  friend: (message: string, messageId: string) => Promise<ChatMessage>;
   ...
   * @returns {Promise<ChatMessage>} ChatGPT Message
   */
  chatGptPromptGenerator: (message: string, messageId: string) => Promise<ChatMessage>;
